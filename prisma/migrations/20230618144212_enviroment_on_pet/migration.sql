...
INSERT INTO "new_pets" ("age", "city", "description", "energy", "id", "independence", "name", "orgId", "photo", "size", "type") SELECT "age", "city", "description", "energy", "id", "independence", "name", "orgId", "photo", "size", "type" FROM "pets";
DROP TABLE "pets";
